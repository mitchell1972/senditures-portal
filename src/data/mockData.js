...
export const products = [
  // Acme Outdoors
  { id: 'p001', vendorId: 'v001', vendorSKU: 'ACM-TN-001', internalSKU: 'SND-10041', upc: '012345600001', productName: 'Trail Navigator Backpack 45L', description: 'Durable 45L hiking backpack with frame support', category: 'Backpacks', cost: 48.00, msrp: 119.99, map: 99.99, quantityOnHand: 312, channelInventory: { Amazon: 150, Website: 92, Wholesale: 70 }, imageUrl: 'https://images.unsplash.com/photo-1622560480605-d83c853bc5c3?w=400', channelAvailability: ['Amazon', 'Website', 'Wholesale'], status: 'active', lastUpdated: '2025-02-14' },
  { id: 'p002', vendorId: 'v001', vendorSKU: 'ACM-TN-002', internalSKU: 'SND-10042', upc: '012345600002', productName: 'Summit Sleeping Bag -10°F', description: 'Mummy-style sleeping bag rated to -10°F', category: 'Sleeping Gear', cost: 62.00, msrp: 159.99, map: 139.99, quantityOnHand: 88, channelInventory: { Amazon: 52, Website: 36 }, imageUrl: 'https://images.unsplash.com/photo-1504851149312-7a075b496cc7?w=400', channelAvailability: ['Amazon', 'Website'], status: 'active', lastUpdated: '2025-02-14' },
  { id: 'p003', vendorId: 'v001', vendorSKU: 'ACM-TN-003', internalSKU: 'SND-10043', upc: '012345600003', productName: 'Ultralight Trekking Poles (Pair)', description: 'Carbon fiber trekking poles, collapsible', category: 'Accessories', cost: 28.00, msrp: 74.99, map: 64.99, quantityOnHand: 0, channelInventory: { Amazon: 0 }, imageUrl: 'https://images.unsplash.com/photo-1551632436-cbf8dd35adfa?w=400', channelAvailability: ['Amazon'], status: 'out_of_stock', lastUpdated: '2025-01-30' },
  { id: 'p004', vendorId: 'v001', vendorSKU: 'ACM-TN-004', internalSKU: 'SND-10044', upc: '012345600004', productName: 'Hydration Pack 2L', description: '2L water reservoir hydration backpack', category: 'Backpacks', cost: 22.00, msrp: 54.99, map: 49.99, quantityOnHand: 204, channelInventory: { Amazon: 100, Website: 60, Wholesale: 44 }, imageUrl: '', channelAvailability: ['Amazon', 'Website', 'Wholesale'], status: 'active', lastUpdated: '2025-02-20' },
  { id: 'p005', vendorId: 'v001', vendorSKU: 'ACM-TN-005', internalSKU: 'SND-10045', upc: '012345600005', productName: 'Waterproof Camp Lantern', description: 'LED lantern, 500 lumens, IPX6 waterproof', category: 'Lighting', cost: 14.50, msrp: 39.99, map: 34.99, quantityOnHand: 155, channelInventory: { Amazon: 95, Website: 60 }, imageUrl: '', channelAvailability: ['Amazon', 'Website'], status: 'active', lastUpdated: '2025-02-14' },
  { id: 'p006', vendorId: 'v001', vendorSKU: 'ACM-TN-006', internalSKU: '', upc: '', productName: 'All-Weather Base Layer Set', description: 'Merino wool base layer, top + bottom', category: 'Apparel', cost: 38.00, msrp: 99.99, map: 89.99, quantityOnHand: 60, channelInventory: {}, imageUrl: '', channelAvailability: [], status: 'pending_review', lastUpdated: '2025-03-05' },
  { id: 'p007', vendorId: 'v001', vendorSKU: 'ACM-TN-007', internalSKU: 'SND-10047', upc: '012345600007', productName: 'Bear Canister 700ci', description: 'Lightweight bear-resistant food canister', category: 'Accessories', cost: 31.00, msrp: 79.99, map: 69.99, quantityOnHand: 42, channelInventory: { Amazon: 42 }, imageUrl: '', channelAvailability: ['Amazon'], status: 'active', lastUpdated: '2025-01-15' },
  { id: 'p008', vendorId: 'v001', vendorSKU: 'ACM-TN-008', internalSKU: 'SND-10048', upc: '012345600008', productName: 'Compact First Aid Kit', description: '100-piece wilderness first aid kit', category: 'Safety', cost: 12.00, msrp: 34.99, map: 29.99, quantityOnHand: 290, channelInventory: { Amazon: 140, Website: 80, Wholesale: 70 }, imageUrl: '', channelAvailability: ['Amazon', 'Website', 'Wholesale'], status: 'active', lastUpdated: '2025-02-14' },
  { id: 'p009', vendorId: 'v001', vendorSKU: 'ACM-TN-009', internalSKU: 'SND-10049', upc: '012345600009', productName: 'Titanium Camp Cookset', description: '4-piece titanium pot and pan set', category: 'Cooking', cost: 44.00, msrp: 109.99, map: 94.99, quantityOnHand: 0, channelInventory: { Amazon: 0 }, imageUrl: '', channelAvailability: ['Amazon'], status: 'discontinued', lastUpdated: '2024-12-01' },
  { id: 'p010', vendorId: 'v001', vendorSKU: 'ACM-TN-010', internalSKU: '', upc: '', productName: 'Solar Charging Panel 21W', description: 'Foldable 21W solar charger for devices', category: 'Electronics', cost: 29.00, msrp: 74.99, map: null, quantityOnHand: 75, channelInventory: {}, imageUrl: '', channelAvailability: [], status: 'draft', lastUpdated: '2025-03-10' },
  // TechGear Pro
  { id: 'p011', vendorId: 'v003', vendorSKU: 'TGP-HW-001', internalSKU: 'SND-20011', upc: '098765400001', productName: 'ProTrack GPS Watch', description: 'Multi-sport GPS watch with HR monitoring', category: 'Wearables', cost: 95.00, msrp: 249.99, map: 219.99, quantityOnHand: 180, channelInventory: { Amazon: 110, Website: 70 }, imageUrl: '', channelAvailability: ['Amazon', 'Website'], status: 'active', lastUpdated: '2025-02-01' },
  { id: 'p012', vendorId: 'v003', vendorSKU: 'TGP-HW-002', internalSKU: 'SND-20012', upc: '098765400002', productName: 'Wireless Earbuds Sport', description: 'IPX7 waterproof wireless earbuds', category: 'Audio', cost: 32.00, msrp: 89.99, map: 79.99, quantityOnHand: 340, channelInventory: { Amazon: 160, Website: 100, Wholesale: 80 }, imageUrl: '', channelAvailability: ['Amazon', 'Website', 'Wholesale'], status: 'active', lastUpdated: '2025-02-01' },
  { id: 'p013', vendorId: 'v003', vendorSKU: 'TGP-HW-003', internalSKU: 'SND-20013', upc: '098765400003', productName: 'Portable Power Bank 26800mAh', description: '26800mAh power bank, 65W PD charging', category: 'Accessories', cost: 28.00, msrp: 69.99, map: 59.99, quantityOnHand: 0, channelInventory: { Amazon: 0 }, imageUrl: '', channelAvailability: ['Amazon'], status: 'out_of_stock', lastUpdated: '2025-01-20' },
  { id: 'p014', vendorId: 'v003', vendorSKU: 'TGP-HW-004', internalSKU: 'SND-20014', upc: '098765400004', productName: 'Smart Scale with App Sync', description: 'Bluetooth body composition scale', category: 'Health', cost: 21.00, msrp: 54.99, map: 44.99, quantityOnHand: 220, channelInventory: { Amazon: 130, Website: 90 }, imageUrl: '', channelAvailability: ['Amazon', 'Website'], status: 'active', lastUpdated: '2025-02-08' },
  { id: 'p015', vendorId: 'v003', vendorSKU: 'TGP-HW-005', internalSKU: '', upc: '', productName: 'Noise-Cancelling Headphones', description: 'Over-ear ANC headphones, 40hr battery', category: 'Audio', cost: 58.00, msrp: 149.99, map: 129.99, quantityOnHand: 90, channelInventory: {}, imageUrl: '', channelAvailability: [], status: 'pending_review', lastUpdated: '2025-03-08' },
]
